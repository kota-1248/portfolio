<template>
  <div id="skillSection">
    ...
    <div id="skillExplain">
      <p>
        ポートフォリオを1人の力で作成したわけではないが、作り上げる事が出来た事からGit、HTML＆CSSの技術はあるものとして考える。他の言語は、知識を蓄えることしかできない為プロゲートで、わかりやすいと思ったものを高得点にしている。
      </p>
    </div>
    <label id="gitHubLabel">
      ...
      <a
        id="gitHubLink"
        href="https://github.com/kota-1248/portfolio"
      > https://github.com/kota.ozawa</a>
    </label>
